...
class BotBlock(nn.Module):
    ...
    The only difference is the replacement of the spatial 3 Ã— 3 convolution layer with Multi-Head Self-Attention (MHSA)
    """
...
class ResNet(nn.Module):
    ...
    def _make_last_layer(self, block, out_channels, num_blocks, stride):
        ...
        W = H = 32
        #you only need to change this ¡ü  32 is 128
        dim_in = 1024
        #dim_in = 256
        dim_out = 2048
