...
class med_dataset(Dataset):
    ...
    def __init__(self,
        ...
        del self.label_file['id']
        del self.label_file['name']"""
       ...
       #Different categories
        ...
        self.locals = self.label_file.iloc[:,6].values   #huangbanshuizhong
    ...
    def __getitem__(self, idx):
        ...
        # / is use to Splicing
        img_name_cfp = self.img_path / (self.id_name[idx] + img_type)
        #img_name_ffa = self.img_path / (self.id_name[idx] )    
        image = Image.open(img_name_cfp)
